...
const TEXT_CONTENTS_DETECTOR_ENDPOINT: &str = "/api/v1/text/contents";

#[derive(Clone)]
pub struct TextContentsDetectorClient(DetectorClient);
...
impl TextContentsDetectorClient {
    ...
    pub async fn text_contents(
        ...
        let url = self.0.client.endpoint(TEXT_CONTENTS_DETECTOR_ENDPOINT);
