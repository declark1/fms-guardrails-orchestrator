...
impl From<Box<ChatCompletion>> for ChatCompletionsResponse {
...
impl From<DetectionResult> for InputDetectionResult {
...
impl From<DetectionResult> for OutputDetectionResult {
    fn from(value: DetectionResult) -> Self {
        Self {
